...
const SearchResultHeader = () => {
  ...
  return (
    <div
      className="p-[15px] pb-0 md:pr-5 md:pl-7 border-b border-[#ebebeb] flex md:block flex-col
    ...
    >
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center grow">
          ...
          <SearchInput from="searchResult"></SearchInput>
        </div>
          ...
          return (
            <span
              ...
              className={`flex items-center p-3  text-[#5f6368]  cursor-pointer relative
               ${selectedMenu === menu.name ? 'text-[#1a73e8]' : null}
              `}
            >
